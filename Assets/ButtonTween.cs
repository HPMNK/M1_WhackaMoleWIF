...
{
	public float scaleAmount = 1.2f; // Facteur d'�chelle pour agrandir le bouton
	public float tweenDuration = 0.2f; // Dur�e de l'animation Tween
	...
	{
		// R�tablir la taille originale lorsque la souris quitte le bouton
